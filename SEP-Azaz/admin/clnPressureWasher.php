              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav">
                  <a href="#" aria-haspopup="true">
                    ...
                    <span class="sidenav-label">Pressure Washer</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div class="layout-content-body">
          <div class="title-bar">
            ...
            <h1 class="title-bar-title">
              <span class="d-ib">Pressure Washer</span>
              <span class="d-ib">
                    ...
                    <li class="product">
                      <div class="product-image">
                        <a class="overlay" href="product.html">
                          <div class="overlay-image">
                            <img class="img-responsive" src="img/pw5.jpg" alt="Raja Elephant T-shirt">
                          </div>
                      ...
                      <div class="product-details">
                        <h5 class="product-name">
                          <a class="link-muted" href="product.html">P1 3480psi 206bar Petrol Pressure Washer</a>
                        </h5>
