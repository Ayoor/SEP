              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav">
                  <a href="#" aria-haspopup="true">
                    ...
                    <span class="sidenav-label">Hydrolic Breaker</span>
                  </a>
                </li>
              </ul>
            </nav>
                    ...
                    <li class="product">
                      <div class="product-image">
                        <a class="overlay" href="product.html">
                          <div class="overlay-image">
                            <img class="img-responsive" src="img/vc2.jpg" alt="Raja Elephant T-shirt">
                          </div>
                      ...
                      <div class="product-details">
                        <h5 class="product-name">
                          <a class="link-muted" href="product.html">Shark Detect Pro With Auto-empty System</a>
                        </h5>
