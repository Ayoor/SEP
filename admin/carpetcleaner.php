              ...
              <ul class="sidenav">
                ...
                <li class="sidenav-item has-subnav">
                  <a href="#" aria-haspopup="true">
                    ...
                    <span class="sidenav-label">Floor Cleaning</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div class="layout-content-body">
          <div class="title-bar">
            ...
            <h1 class="title-bar-title">
              <span class="d-ib">Floor  Cleaning</span>
              <span class="d-ib">
                      ...
                      <div class="product-image">
                        <a class="overlay" href="product.html">
                          <div class="overlay-image">
                            <img class="img-responsive" src="img/fc1.jpg" alt="Raja Elephant T-shirt">
                          </div>
                          <div class="overlay-content overlay-top">
                            <span class="label label-success pull-right">Not Available!</span>
                          </div>
                        </a>
                      </div>
                      <div class="product-details">
                        <h5 class="product-name">
                          <a class="link-muted" href="product.html">Floor Cleaning</a>
                        </h5>
