      ...
      <nav id="sidenav" class="sidenav-collapse collapse">
        <ul class="sidenav">
          ...
          <li class="sidenav-item">
              ...
              <span class="sidenav-label sidepaneltitle text-center bg-primary">Categories</span>
          ...
          ?>
              ...
              <li class="sidenav-subheading">
                <a href='viewequipments.php?category=<?php echo urlencode($categoryName); ?>' aria-haspopup="true">
